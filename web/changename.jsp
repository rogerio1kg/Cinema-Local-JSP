...
<html>
    ...
    <body>
        ...
        <main>
            <form id="login_form" class="form_class" action="<%=request.getContextPath() %>/updateName" method="GET">
                <div class="form_div">
                        <label>Novo usuário:</label>
                        <input class="field_class" name="username" type="text" placeholder="Insira o nome desejado" required>
